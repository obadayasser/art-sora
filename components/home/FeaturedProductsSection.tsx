          ...
          {[1, 2, 3, 4, 5].map((star) => (
            <Star
              ...
              className={`w-3 h-3 md:w-4 md:h-4 ${
                star <= 5 ? 'text-yellow-400 fill-yellow-400' : 'text-gray-300 dark:text-gray-600'
              }`}
            />
          ))}
          <span className="text-xs text-gray-500 dark:text-gray-400 ml-2 font-semibold">5.0</span>
        </div>
